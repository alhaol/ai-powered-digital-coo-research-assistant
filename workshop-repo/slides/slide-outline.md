# 📊 Slide Deck Outline — The Lean Startup AI Assistant

**Slide count:** 50 · **Theme:** Dark background, green/earth-tone accents
**Rendered deck:** see `../../presentation/index.html` (self-contained HTML)
...
| 16 | Exercise 1B: Prompt | Interview script prompt |
| 17 | Exercise 1C: Prompt | Landing page brief prompt |
| 18 | Show & Tell | Display attendee outputs + command files |
| 19 | Module 1 Recap | ✅ Hypothesis ✅ Script ✅ Landing ✅ First Command |

## Section 3 — Module 2: MEASURE (Slides 20–28)
| # | Title | Content |
|---|-------|---------|
...
| 26 | 🔧 Exercise 2B-cmd | Build the analysis command |
| 27 | "So What?" + Chaining Preview | Iterative prompting; command chaining |
| 28 | Module 2 Recap | ✅ Matrix ✅ Report ✅ Insights ✅ 2 Commands |

## Section 4 — Module 3: LEARN (Slides 29–37)
| # | Title | Content |
|---|-------|---------|
...
| 37 | Module 3 Recap | ✅ Pivot ✅ Sprint ✅ 2 Commands (solo!) |

## Section 5 — Module 4: OPERATE (Slides 38–44)
| # | Title | Content |
|---|-------|---------|
| 38 | "Don't Hire a COO. Prompt One." | Quote slide |
| 39 | From Prompts → Commands → Skills | Progression completed |
| 40 | Commands vs. Skills | Side-by-side comparison table |
| 41 | Exercise 4A: SOP Generator | SOP prompt + command |
| 42 | 🔧 Exercise 4B: The Capstone | Build a Skill — folder, SKILL.md, templates |
| 43 | Power Tips | Chaining, context, version control, batch |
| 44 | Module 4 Recap | ✅ SOP ✅ Skill ✅ Complete Toolkit |
...
| 49 | Resources | Repo QR, booklet, docs links |
| 50 | Q&A | "What questions do you have?" |
